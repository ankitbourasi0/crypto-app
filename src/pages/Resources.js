  ...
  return (
    <div className="w-full font-poppins pb-24  bg-gradient-to-tr from-purple-600  ">
      <div className="max-w-6xl min-h-[90vh] mb-12 justify-between flex pt-44 w-full mx-auto">
        <div>
          <h1 className="max-w-lg w-full mb-12 text-5xl font-extrabold">
            Discover,
            <br />
          ...
          <button className="px-12 py-3 border-4 bg-gradient-to-r from-purple-700 to-rose-800 shadow-2xl shadow-rose-500 rounded-3xl text-xl">
            Explore
          </button>
        </div>
        <div className="max-w-[600px]  w-full ">
          ...
          <div className="mt-24  space-y-6">
            <div className="flex space-x-8">
              <div className="max-w-[150px] w-full min-h-[150px] bg-white ">
                <p>lsfvs</p>
              </div>
              <div className="max-w-[150] min-h-[150px]  flex justify-center  items-center rounded-full text-purple-500 bg-purple-500 ">
                "fsvvsdkmvlsdm,wmw f,me ,m ea m, s"
              </div>
            </div>
            <div className="flex space-x-8">
              <div className="max-w-[150] min-h-[150px]  flex justify-center  items-center rounded-l-full text-gray-500 bg-gray-500 ">
                sdvhbsdvknakvlk aslv akvksvkkkjnvkjs,
              </div>
              <div className="max-w-[150] min-h-[150px]  flex justify-center  items-center rounded-full text-red-500 bg-red-500">
                lkmcealmk;adnksvs
              </div>
            </div>
          </div>
      ...
      <h1 className="text-3xl font-semibold mb-8 mt-24 text-center">
        Browse by Category
      </h1>

      <div className="max-w-7xl mx-auto w-full mb-44 ">
        <div className="w-full flex  ml-44 space-x-6">
          <div className="rounded-3xl max-w-[300px] flex justify-center items-center text-2xl text-black min-h-[300px] w-full bg-gray-100">
            Videos
          </div>
          <div className="rounded-3xl max-w-[300px] flex justify-center items-center text-2xl text-black  min-h-[300px] w-full bg-gray-100">
            Photo
      ...
      <div className="w-full max-w-6xl flex justify-between  mx-auto">
       ...
       <div className="px-16 py-24 max-w-[550px] overflow-scroll max-h-[550px]  space-y-8">
        <div className="w-full  bg-neutral-900 shadow-lg shadow-black flex text-xl items-center font-semibold rounded-xl border-2 border-purple-800 px-6 py-4 ">
          ...
          </div> <div className="w-full  bg-neutral-900 shadow-lg shadow-black flex text-xl items-center font-semibold rounded-xl border-2 border-purple-800 px-6 py-4 ">
      ...
      <div className="max-w-6xl my-44 rounded-3xl min-h-[70vh] text-3xl flex justify-center items-center bg-rose-700 mx-auto w-full ">
        Play
      </div>
    </div>
  );
